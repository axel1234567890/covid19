...
const LAYOUTS = [
  {
    id: 'big-picture',
    name: 'vue-d-ensemble',
    label: 'Vue d’ensemble modifiée',
    component: <BigPicture />
  },
  {
    id: 'indicators',
    name: 'suivi-indicateurs',
    label: 'Carte des indicateurs modifiée',
  ...
  },
  {
    ...
    label: 'Aides entreprises modifiée',
...
const MainPage = () => {
  ...
  return (
    <Page title='Tableau de bord modifié de suivi de l’épidémie de coronavirus en France'>
