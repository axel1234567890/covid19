...
const covidHospitUrl = 'http://10.0.2.15/cov2/covid19-dashboard/scripts/prepare-data/donnees-hospitalieres.csv'
const covidHospitNouveauxUrl = 'http://10.0.2.15/cov2/covid19-dashboard/scripts/prepare-data/donnees-hospitalieres-nouveaux.csv'
...
async function buildHospiSpfFrance() {
  const rows = await fetchCsv('http://10.0.2.15/cov2/covid19-dashboard/scripts/prepare-data/table-indicateurs.csv')
  return rows
    .map(row => ({
      code: 'FRA',
      nom: 'France',
