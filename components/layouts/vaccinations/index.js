...
const DesktopVaccinations = () => {
  return (
    <>
      ...
      <div className='map'>
        <TerritoriesDesktopMap maps={VaccinationsMaps} context={VaccinationsContext} disableMapSelector />
      </div>
...
const Vaccinations = props => {
  ...
  const [selectedMapId, setSelectedMapId] = useState('Nombre de premières doses modifiés injectées (au total)')
